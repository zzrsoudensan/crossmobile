...
public class XMLUtils {
    ...
    public static void saveXML(Document doc, File outfile) throws BuildException {
        try {
    ...
    public static int checkValidClass(String name, String clazz) throws BuildException {
        if (clazz == null)
    ...
    public static Node getNodeWithName(Node parent, String name) throws BuildException {
